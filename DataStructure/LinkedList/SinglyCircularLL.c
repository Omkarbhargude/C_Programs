...
int SearchElement(PNODE first, PNODE last, int no)
{ 
    int iCount = 0;
...
int main()
{
    ...
    while(1)
    {
        ...
        {
            case 1:
                printf("Enter data the you want to insert : \n");
                scanf("%d",&iValue);
            ...
            case 3:
                printf("Enter the data that that you want to insert : \n");
                scanf("%d",&iValue);
            ...
            case 9:
               ...
               int iRet = SearchElement(head,tail,iValue);
